...
namespace OgreVent
{
    public class ImportedSpiritsShop
    {
        ...
        public static void Actions(string Action)
        {
            ...
            MyAction = Action;
            if (Program.Location == "Imported Spirits Shop")
            {
                switch (MyAction.ToUpper())
                {
                    case "LOOK FORWARD":
                        Poster.Post("In front of you," +
                            " is an assortment of red wine in bottles of all sizes and shapes," +
                            " with fancy labels and insignias, crested with the year they originate from'");
                        break;
                    case "LOOK LEFT":
                        Poster.Post("To your left," +
                            " there are shelves and crates on display with various liquors and liqueurs most of the bottles come in smaller sizes," +
                            " the shopkeeper is standing beside a crate tasting some fine brandy while speaking with a customer");
                        break;
                    case "LOOK RIGHT":
                        Poster.Post("To the right," +
                            " there are shelves of white wine and oddly enough an assortment" +
                            " of cheeses that are supposed to go well along with" +
                            " as many bottles of wine the shopkeep is able to sell you");
                        break;
                    case "LOOK BEHIND":
                    ...
                    case "TALK TO SHOPKEEP":
                        ...
                        Poster.Post("the shopkeep greets you with a hand gesture unfamiliar to you, then he says 'halla balla, may i interest you in some of my wares?'");
                        ...
                        if (tempA == "PRICES")
                        {
                            Poster.Post("bottle of red wine: 3 Gold");
                            Poster.Post("bottle of white wine: 3 Gold", 0, false);
                            Poster.Post("bottle of whiskey: 7 Gold", 0, false);
                            Poster.Post("bottle of rum: 10 Gold", 0, false);
                            Poster.Post("bottle of fruit liqueur: 5 Gold", 0, false);
                        }
                        else
                        {
